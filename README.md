...
### Employer Dashboard
![Employer Dashboard](./Outputs/Employer_portal.png)
...
### Recruiter Dashboard
![Recruiter Dashboard](./Outputs/Recruiter_Dashboard.png)
- AI-powered search
- Professional stats
...
### Job Creation
![Job Creation](./Outputs/Employer_jobcreation.png)
- Drag & drop form builder
- Custom field types
- Real-time preview

### AI Ranking
![AI Ranking](./Outputs/Employer_application_raking.png)
- Scored candidates (50-95)
- Detailed rationale
- Visual indicators
- Sort by score

### Candidate Search
![Candidate Search](./Outputs/Candidate_search_portal.png)
- Advanced filters
- LinkedIn-like cards
